...
class ReportController with ChangeNotifier {
  ...
  void fetchTransaction(
   ...
   total = totalIncome - totalExpense;
    ...
    vehicleIncomeAmount = amountCalc(transactionIncomeList, car);
    vehicleExpenseAmount = amountCalc(transactionExpenseList, car);
    ...
    officeIncomeAmount = amountCalc(transactionIncomeList, bills);
    officeExpenseAmount = amountCalc(transactionExpenseList, bills);
